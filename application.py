...
def main():
    ...
    sort_engine.run_quicksort_all_data_types(100000, generate_chart=True, generate_file=False, write_numbers_list=True)

    # TESTS - Run quick sort for all quantity of numbers - Random data type
    sort_engine.run_quicksort_all_quantity(0, generate_chart=True, generate_file=False, write_numbers_list=False)
